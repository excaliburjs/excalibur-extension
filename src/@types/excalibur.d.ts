...
declare class Entity<TKnownComponents extends Component = any> implements OnInitialize, OnPreUpdate, OnPostUpdate, OnAdd, OnRemove {
   ...
   * @param force
   */
  removeComponent<TComponent extends Component>(
...
type QueryEntity<
  ...
  TAnyComponentCtors extends ComponentCtor<Component> = never
> = [TAnyComponentCtors] extends [never]
...
declare class QueryManager {
  ...
  createQuery<TKnownComponentCtors extends ComponentCtor<Component> = never, TAnyComponentCtors extends ComponentCtor<Component> = never>(
...
declare class Animation extends Graphic implements HasTick {
   ...
   */
  static fromSpriteSheet<T extends typeof Animation>(
    this: T,
    spriteSheet: SpriteSheet,
 ...
 * @param variable
 */
declare function getGLTypeFromSource(
  gl: WebGLRenderingContext,
  source: string,
  variable: string
): 5121 | 5124 | 5125 | 5126 | 5122 | 5123 | 5120 | 35670;
/**
...
declare namespace webglUtil {
  export {
    webglUtil_getAttributeComponentSize as getAttributeComponentSize,
    webglUtil_getAttributePointerType as getAttributePointerType,
    webglUtil_getGLTypeFromSource as getGLTypeFromSource,
    webglUtil_getGlTypeSizeBytes as getGlTypeSizeBytes,
    webglUtil_getMaxShaderComplexity as getMaxShaderComplexity,
    webglUtil_isAttributeInSource as isAttributeInSource
  };
}
...
type TileMapEvents = EntityEvents &
  TilePointerEvents & {
...
declare class Tile {
  ...
  on(eventName: string, handler: Handler<unknown>): Subscription;
  once<TEventName extends EventKey<TilePointerEvents>>(
...
declare namespace Events {
  export {
    Events_ActionCompleteEvent as ActionCompleteEvent,
    Events_ActionStartEvent as ActionStartEvent,
    Events_ActivateEvent as ActivateEvent,
    Events_AddEvent as AddEvent,
    Events_CollisionEndEvent as CollisionEndEvent,
    Events_CollisionPostSolveEvent as CollisionPostSolveEvent,
    Events_CollisionPreSolveEvent as CollisionPreSolveEvent,
    Events_CollisionStartEvent as CollisionStartEvent,
    Events_ContactEndEvent as ContactEndEvent,
    Events_ContactStartEvent as ContactStartEvent,
    Events_DeactivateEvent as DeactivateEvent,
    Events_EnterTriggerEvent as EnterTriggerEvent,
    Events_EnterViewPortEvent as EnterViewPortEvent,
    Events_EventTypes as EventTypes,
    Events_ExitTriggerEvent as ExitTriggerEvent,
    Events_ExitViewPortEvent as ExitViewPortEvent,
    Events_GameEvent as GameEvent,
    Events_GameStartEvent as GameStartEvent,
    Events_GameStopEvent as GameStopEvent,
    Events_GamepadAxisEvent as GamepadAxisEvent,
    Events_GamepadButtonEvent as GamepadButtonEvent,
    Events_GamepadConnectEvent as GamepadConnectEvent,
    Events_GamepadDisconnectEvent as GamepadDisconnectEvent,
    Events_HiddenEvent as HiddenEvent,
    Events_InitializeEvent as InitializeEvent,
    Events_KillEvent as KillEvent,
    Events_PostCollisionEvent as PostCollisionEvent,
    Events_PostDebugDrawEvent as PostDebugDrawEvent,
    Events_PostDrawEvent as PostDrawEvent,
    Events_PostFrameEvent as PostFrameEvent,
    Events_PostKillEvent as PostKillEvent,
    Events_PostTransformDrawEvent as PostTransformDrawEvent,
    Events_PostUpdateEvent as PostUpdateEvent,
    Events_PreCollisionEvent as PreCollisionEvent,
    Events_PreDebugDrawEvent as PreDebugDrawEvent,
    Events_PreDrawEvent as PreDrawEvent,
    Events_PreFrameEvent as PreFrameEvent,
    Events_PreKillEvent as PreKillEvent,
    Events_PreTransformDrawEvent as PreTransformDrawEvent,
    Events_PreUpdateEvent as PreUpdateEvent,
    Events_RemoveEvent as RemoveEvent,
    Events_VisibleEvent as VisibleEvent,
    type Events_activate as activate,
    type Events_add as add,
    type Events_axis as axis,
    type Events_button as button,
    type Events_cancel as cancel,
    type Events_collisionend as collisionend,
    type Events_collisionstart as collisionstart,
    type Events_connect as connect,
    type Events_deactivate as deactivate,
    type Events_disconnect as disconnect,
    type Events_down as down,
    type Events_enter as enter,
    type Events_entertrigger as entertrigger,
    type Events_enterviewport as enterviewport,
    type Events_exittrigger as exittrigger,
    type Events_exitviewport as exitviewport,
    type Events_hidden as hidden,
    type Events_hold as hold,
    type Events_initialize as initialize,
    type Events_kill as kill,
    type Events_leave as leave,
    type Events_move as move,
    type Events_pointercancel as pointercancel,
    type Events_pointerdown as pointerdown,
    type Events_pointerdragend as pointerdragend,
    type Events_pointerdragenter as pointerdragenter,
    type Events_pointerdragleave as pointerdragleave,
    type Events_pointerdragmove as pointerdragmove,
    type Events_pointerdragstart as pointerdragstart,
    type Events_pointerenter as pointerenter,
    type Events_pointerleave as pointerleave,
    type Events_pointermove as pointermove,
    type Events_pointerup as pointerup,
    type Events_pointerwheel as pointerwheel,
    type Events_postcollision as postcollision,
    type Events_postdebugdraw as postdebugdraw,
    type Events_postdraw as postdraw,
    type Events_postframe as postframe,
    type Events_postkill as postkill,
    type Events_postupdate as postupdate,
    type Events_precollision as precollision,
    type Events_predebugdraw as predebugdraw,
    type Events_predraw as predraw,
    type Events_preframe as preframe,
    type Events_prekill as prekill,
    type Events_press as press,
    type Events_preupdate as preupdate,
    type Events_release as release,
    type Events_remove as remove,
    type Events_start as start,
    type Events_stop as stop,
    type Events_subscribe as subscribe,
    type Events_unsubscribe as unsubscribe,
    type Events_up as up,
    type Events_visible as visible,
    type Events_wheel as wheel
  };
}
...
type PossibleSounds<TSoundMangerOptions> = TSoundMangerOptions extends SoundManagerOptions
...
declare namespace DrawUtil {
  export {
    type DrawUtil_BorderRadius as BorderRadius,
    type DrawUtil_LineCapStyle as LineCapStyle,
    DrawUtil_circle as circle,
    DrawUtil_line as line,
    DrawUtil_point as point,
    DrawUtil_roundRect as roundRect,
    DrawUtil_vector as vector
  };
}
...
declare namespace Index {
  export {
    type Index_Appender as Appender,
    Index_ConsoleAppender as ConsoleAppender,
    Index_DrawUtil as DrawUtil,
    type Index_EasingFunction as EasingFunction,
    Index_EasingFunctions as EasingFunctions,
    Index_LogLevel as LogLevel,
    Index_Logger as Logger,
    type Index_MaybeObserver as MaybeObserver,
    type Index_Message as Message,
    Index_Observable as Observable,
    type Index_Observer as Observer,
    Index_ScreenAppender as ScreenAppender,
    type Index_ScreenAppenderOptions as ScreenAppenderOptions,
    Index_addItemToArray as addItemToArray,
    Index_contains as contains,
    Index_delay as delay,
    Index_fail as fail,
    Index_getMinIndex as getMinIndex,
    Index_getPosition as getPosition,
    Index_isObject as isObject,
    Index_mergeDeep as mergeDeep,
    Index_omit as omit,
    Index_removeItemFromArray as removeItemFromArray
  };
}
...
export {
  ...
  Canvas,
  type CanvasOptions,
  type CapturePointerConfig,
  ChannelCollection,
  type ChannelSoundsConfiguration,
  Circle,
  CircleCollider,
  type CircleColliderOptions,
  type CircleOptions,
  Clock,
  type ClockOptions,
  type Clonable,
  ...
  type CollisionProcessor,
  type CollisionSolver,
  CollisionStartEvent,
  CollisionSystem,
  CollisionType,
  Color,
  ...
  DisplayMode,
  type DistributeEntity,
  DynamicTree,
  DynamicTreeCollisionProcessor,
  type DynamicTreeConfig,
  EX_VERSION,
  EaseBy,
  EaseTo,
  type EasingFunction,
  ...
  ExResponse,
  type ExResponseType,
  type ExResponseTypesLookup,
  type ExcaliburGraphicsContext,
  ExcaliburGraphicsContext2DCanvas,
  type ExcaliburGraphicsContext2DOptions,
  type ExcaliburGraphicsContextOptions,
  type ExcaliburGraphicsContextState,
  ExcaliburGraphicsContextWebGL,
  type ExcaliburGraphicsContextWebGLOptions,
  ExitTriggerEvent,
  ExitViewPortEvent,
  Fade,
  FadeInOut,
  ...
  FontUnit,
  FpsSampler,
  type FpsSamplerOptions,
  type Frame,
  type FrameActorStats,
  type FrameDurationStats,
  type FrameEvent,
  type FrameStatistics,
  FrameStats,
  type FromSpriteSheetOptions,
  ...
  type GraphicOptions,
  GraphicsComponent,
  type GraphicsComponentOptions,
  GraphicsGroup,
  type GraphicsGrouping,
  type GraphicsGroupingOptions,
  type GraphicsShowOptions,
  ...
  InitializeEvent,
  InputHost,
  type InputHostOptions,
  InputMapper,
  type InputsOptions,
  IsometricEntityComponent,
  type IsometricEntityComponentOptions,
  IsometricEntitySystem,
  IsometricMap,
  type IsometricMapOptions,
  IsometricTile,
  type IsometricTilePointerEvents,
  KeyEvent,
  Keyboard,
  ...
  Logger,
  Material,
  type MaterialImageOptions,
  type MaterialOptions,
  Matrix,
  MatrixLocations,
  type MaybeKnownComponent,
  type MaybeObserver,
  MediaEvent,
  Meet,
  type Message,
  ...
  type ParticleConfig,
  ParticleEmitter,
  type ParticleEmitterArgs,
  ParticleRenderer,
  ParticleTransform,
  type PhysicsConfig,
  type PhysicsStatistics,
  PhysicsStats,
  PhysicsWorld,
  type PixelRatioChangeEvent,
  ...
  type PointerEvents$1 as PointerEvents,
  type PointerInitOptions,
  PointerScope,
  PointerSystem,
  PointerType,
  Polygon,
  PolygonCollider,
  type PolygonColliderOptions,
  type PolygonOptions,
  Pool,
  PositionNode,
  ...
  SceneEvents,
  type SceneMap,
  type SceneWithOptions,
  type ScheduleId,
  type ScheduledCallbackTiming,
  Screen,
  ScreenAppender,
  type ScreenAppenderOptions,
  ScreenElement,
  ScreenEvents,
  type ScreenOptions,
  ...
  type TilePointerEvents,
  TiledAnimation,
  type TiledAnimationOptions,
  TiledSprite,
  type TiledSpriteOptions,
  Timer,
  type TimerOptions,
  Toaster,
  Transform,
  ...
  type VertexAttributeDefinition,
  VertexBuffer,
  ...
  type pointerdown,
  type pointerdragend,
  type pointerdragenter,
  type pointerdragleave,
