...
export class DebugSettings extends LitElement {
          ...
          <div class="form-row">
            ...
            <div>
              <sl-color-picker
                ...
                opacity
                @sl-input=${this._handleColorInput('posColor')}
          ...
          <div class="form-row">
            ...
            <div>
              <sl-color-picker
                ...
                opacity
                @sl-input=${this._handleColorInput('rotationColor')}
                >Color</sl-color-picker
              >
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <div>
              <sl-color-picker
                ...
                opacity
                @sl-input=${this._handleColorInput('scaleColor')}
                >Color</sl-color-picker
              >
            </div>
          </div>
    ...
    return html`
      ...
      <div class="section">
        <form>
          ...
          <div>
            <sl-switch id="show-ids" .checked=${settingsStore.get('showIds')} @sl-change=${this._handleSwitchChange('showIds')}></sl-switch>
        ...
        <form>
          <div class="form-row">
            ...
            <sl-color-picker
              ...
              opacity
              @sl-input=${this._handleColorInput('debugTextForegroundColor')}
              >Foreground Color
            </sl-color-picker>
          </div>
          ...
          <div class="form-row">
            ...
            <sl-color-picker
              ...
              opacity
              @sl-input=${this._handleColorInput('debugTextBackgroundColor')}
              >Background Color
            </sl-color-picker>
          </div>
          ...
          <div class="form-row">
            ...
            <sl-color-picker
              ...
              opacity
              @sl-input=${this._handleColorInput('debugTextBorderColor')}
              >Background Color
            </sl-color-picker>
          </div>
        </form>
        ...
        <form>
          <div class="form-row">
            ...
            <sl-color-picker
              ...
              opacity
              @sl-input=${this._handleColorInput('contactNormalColor')}
          ...
          <div class="form-row">
            ...
            <sl-color-picker
              ...
              opacity
              @sl-input=${this._handleColorInput('contactColor')}
              >Contact Color
            </sl-color-picker>
          </div>
        ...
        <form>
          <div class="form-row">
            ...
            <sl-color-picker
              ...
              opacity
              @sl-input=${this._handleColorInput('tileMapGridColor')}
              >Grid Tilemap Color
            </sl-color-picker>
          </div>
          ...
          <div class="form-row">
            ...
            <sl-color-picker
              ...
              opacity
              @sl-input=${this._handleColorInput('isometricGridColor')}
              >Grid Isometric Color
            </sl-color-picker>
          </div>
        </form>
      </div>
  ...
  render() {
    return html`
      ...
      <div class="row">
        <div class="widget">${this.transformHtml()} ${this.componentsHtml()}</div>

        <div class="widget">${this.entityHtml()} ${this.debugTextHtml()}</div>
      </div>

      <div class="row">
        <div class="widget">${this.physicsHtml()}</div>

        <div class="widget">${this.tilemapHtml()}</div>
      </div>
    `;
  }
}
